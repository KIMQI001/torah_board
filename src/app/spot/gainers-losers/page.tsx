...
import { ExternalLink, RefreshCw, AlertCircle, TrendingUp } from 'lucide-react';
import { Button } from '@/components/ui/button';

export default function MarketAnomalyPage() {
  ...
  const openInNewTab = () => {
    window.open('https://www.coinglass.com/zh/gainers-losers', '_blank');
  };
  ...
  return (
    <div className="h-screen w-full relative">
      ...
      <div className="sticky top-0 z-20 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b px-6 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold">市场异动数据</h1>
            <span className="text-sm text-muted-foreground">• 实时涨跌榜</span>
          </div>
      ...
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center bg-background/80 z-10">
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground">正在加载市场异动数据...</p>
          </div>
        </div>
      )}
      ...
      {iframeError && (
        <div className="absolute inset-0 flex items-center justify-center bg-background z-10">
          <div className="text-center space-y-4 p-6">
            ...
            <h2 className="text-2xl font-bold">无法嵌入 Coinglass 涨跌榜</h2>
      ...
      <div className="h-[calc(100vh-4rem)] w-full">
        <iframe 
          id="coinglass-iframe"
          src="https://www.coinglass.com/zh/gainers-losers"
          className="w-full h-full border-0 rounded-lg"
          title="Coinglass 市场异动 - 涨跌榜"
          frameBorder="0"
          allowFullScreen
